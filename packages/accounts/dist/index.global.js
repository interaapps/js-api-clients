var accounts = (function (exports) {
  ...
  var exceptions = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AccountNotGrantedApp: AccountNotGrantedApp,
    AlreadyLinked: AlreadyLinked,
    Authentication: Authentication,
    AuthenticationInvalid: AuthenticationInvalid,
    ChallengeFailed: ChallengeFailed,
    HTTP: HTTP,
    InteraAppsAccountsException: InteraAppsAccountsException,
    InternalError: InternalError,
    InvalidRequest: InvalidRequest,
    NamespacePermissionsDenied: NamespacePermissionsDenied,
    NotFound: NotFound,
    PermissionsDenied: PermissionsDenied,
    PrivacyPoliciesNotChecked: PrivacyPoliciesNotChecked,
